...
const nodes = [
	{
		...
		group: "explore",
		phase: "early",
		desc: "Learn the world, routes, zones, and where things are.",
	},
	{
		id: "Q",
		name: "Quest",
		group: "level",
		phase: "early",
		desc: "Take directed objectives that push progression forward.",
	},
	{
		id: "C",
		name: "Fight",
		group: "level",
		phase: "early",
		desc: "Kill things, learn your class, and survive the world.",
	},
	{
		id: "XP",
		name: "Level",
		group: "level",
		phase: "mid",
		desc: "Gain levels, talents, and access to stronger content.",
	},
	{
		id: "G",
		name: "Earn Gold",
		group: "econ",
		phase: "mid",
		desc: "Build up liquid resources for skills, travel, and upkeep.",
	},
	{
		id: "P",
		name: "Craft",
		group: "econ",
		phase: "mid",
		desc: "Gather and craft to support your character or make money.",
	},
	{
		id: "L",
		name: "Gear",
		group: "level",
		phase: "late",
		desc: "Convert time and success into stronger equipment.",
	},
	{
		id: "S",
		name: "Group Up",
		group: "social",
		phase: "late",
		desc: "Join guilds, form groups, and coordinate progression.",
	},
	{
		id: "R",
		name: "Raid",
		group: "social",
		phase: "endgame",
		desc: "Tackle structured cooperative endgame for prestige and rewards.",
	},
	{
		id: "D",
		name: "Dungeon",
		group: "social",
		phase: "endgame",
		desc: "Engage in challenging group content for rewards and progression.",
	},
];
...
const links = [
	{
		...
		target: "Q",
		type: "primary",
		note: "Exploration exposes new quest hubs.",
	},
	{
		source: "Q",
		target: "C",
		type: "intra-phase",
		note: "Quests repeatedly send you into combat inside early game.",
	},
	{
		source: "C",
		target: "XP",
		type: "primary",
		note: "Combat and completion push leveling.",
	},
	{
		source: "XP",
		target: "G",
		type: "primary",
		note: "Progression improves earning power and content access.",
	},
	{
		source: "G",
		target: "P",
		type: "intra-phase",
		note: "Gold funds the economy loop and profession growth inside mid game.",
	},
	{
		source: "P",
		target: "L",
		type: "primary",
		note: "Crafting and the market help convert wealth into gear.",
	},
	{
		source: "L",
		target: "S",
		type: "intra-phase",
		note: "Power growth makes coordinated group content realistic inside late game.",
	},
	{
		source: "L",
		target: "D",
		type: "intra-phase",
		note: "Power growth makes dungeon content realistic inside late game.",
	},
	{
		source: "S",
		target: "R",
		type: "primary",
		note: "Stable groups unlock raid progression.",
	},

	{
		...
		target: "P",
		type: "support",
		note: "Exploration also reveals resource routes.",
	},
	{
		source: "E",
		target: "C",
		type: "intra-phase",
		note: "Wandering the world often drops you into fights before anything else.",
	},
	{
		source: "Q",
		target: "G",
		type: "support",
		note: "Questing is an early gold source.",
	},
	{
		source: "XP",
		target: "Q",
		type: "support",
		note: "Leveling unlocks more quests and zones.",
	},
	{
		source: "XP",
		target: "P",
		type: "intra-phase",
		note: "Mid-game progression often branches into professions and side economies.",
	},
	{
		source: "G",
		target: "L",
		type: "support",
		note: "Gold helps turn progression into better gear.",
	},
	{
		source: "L",
		target: "C",
		type: "support",
		note: "Better gear loops back into easier combat.",
	},
	{
		source: "L",
		target: "S",
		type: "intra-phase",
		note: "Late-game gearing and grouping reinforce each other.",
	},
	{
		source: "R",
		target: "L",
		type: "support",
		note: "Raids feed back into the gearing ladder.",
	},
	{
		source: "R",
		target: "S",
		type: "support",
		note: "Raiding strengthens social structures that sustain endgame.",
	},

	{
		...
		target: "G",
		type: "cost",
		note: "Repairs and upgrades drain gold.",
	},
	{
		source: "R",
		target: "G",
		type: "cost",
		note: "Raid prep and consumables create recurring costs.",
	},
	{
		source: "D",
		target: "G",
	...
	},
	{
		...
		target: "S",
		type: "friction",
		note: "Scheduling and coordination strain groups over time.",
	},
];
